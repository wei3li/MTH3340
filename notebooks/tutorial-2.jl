...
function compute_solution(N,order,u)
  ...
  dΩ_super = Measure(trian, 4(degree + 1))
...
# ╔═╡ efe16e43-f10c-4117-918e-9b573df60741
begin
	ndofs_5_1 = [dofs[5:end] for dofs in ndofs_5]
	eh1_5_1 = [eh1s[5:end] for eh1s in eh1_5]
	slope_5_1 = compute_slope(ndofs_5_1,eh1_5_1,log10,log10)
end
